...
const AvatarMenue = () => {
    ...
    return (
        <div className="relative border-t lg:border-none">
            ...
            <ul className={`bg-white top-14 right-0 mt-6 space-y-6 lg:absolute lg:border lg:rounded-md lg:w-52 lg:shadow-md lg:space-y-0 lg:mt-0 z-50 ${state ? '' : 'lg:hidden'}`}>
                {
...
export default () => {
    ...
    return (
        <header className="text-base lg:text-sm">
            <div className={`bg-white items-center gap-x-14 px-4 max-w-screen-xl mx-auto lg:flex lg:px-8 lg:static z-50 ${state ? "h-full fixed inset-x-0" : ""}`}>
